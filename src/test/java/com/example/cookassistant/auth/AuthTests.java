package com.example.cookassistant.auth;
...
public class AuthTests {
    ...
    @Test
    @DisplayName("POST /member/login으로 올바른 username , password등 데이터를 넘기면 JWT 키를 발급해준다 ")
    ...
    @Test
    @DisplayName("POST /member/login 으로 올바르지 않은 email과 password 데이터를 넘기면 400")
    ...
    @Test
    @DisplayName("POST /uesr/login 호출할 때 올바르지 않는 eamil 이나 password 를 입력하면 400")
